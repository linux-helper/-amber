...
# static fields
.field private static a:I = 0x7f050000
...
.method public constructor <init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    iput-object v0, p0, Lcom/androlua/LuaResources;->b:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->c:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->d:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->e:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->f:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->h:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->i:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->j:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/androlua/LuaResources;->k:Ljava/util/HashMap;
...
.method public __index(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/androlua/LuaResources;->get(Ljava/lang/String;)Ljava/lang/Object;
...
.method public __newIndex(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/androlua/LuaResources;->put(Ljava/lang/String;Ljava/lang/Object;)I
...
.method public get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->k:Ljava/util/HashMap;
...
.method public getAnimation(I)Landroid/content/res/XmlResourceParser;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->l:Landroid/content/res/Resources;
...
.method public getBoolean(I)Z
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->j:Ljava/util/HashMap;
...
.method public getColor(I)I
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->d:Ljava/util/HashMap;
...
.method public getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->c:Ljava/util/HashMap;
...
.method public getFont(I)Landroid/graphics/Typeface;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->g:Ljava/util/HashMap;
...
.method public getIntArray(I)[I
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->f:Ljava/util/HashMap;
...
.method public getInteger(I)I
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->h:Ljava/util/HashMap;
...
.method public getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/androlua/LuaResources;->getText(I)Ljava/lang/CharSequence;
...
.method public varargs getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/androlua/LuaResources;->getString(I)Ljava/lang/String;
...
.method public getStringArray(I)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->e:Ljava/util/HashMap;
...
.method public getText(I)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lcom/androlua/LuaResources;->b:Ljava/util/HashMap;
...
.method public put(Ljava/lang/String;Ljava/lang/Object;)I
    .locals 3

    if-eqz p2, :cond_5

    sget v0, Lcom/androlua/LuaResources;->a:I

    add-int/lit8 v1, v0, 0x1

    sput v1, Lcom/androlua/LuaResources;->a:I
    ...
    invoke-virtual {p0, v0, p2}, Lcom/androlua/LuaResources;->setDrawable(ILandroid/graphics/drawable/Drawable;)V

    :goto_0
    iget-object v1, p0, Lcom/androlua/LuaResources;->k:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v0, p2}, Lcom/androlua/LuaResources;->setText(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p2}, Lcom/androlua/LuaResources;->setTextArray(I[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/androlua/LuaResources;->setColor(II)V
    ...
    invoke-virtual {p0, v0, p2}, Lcom/androlua/LuaResources;->setIntArray(I[I)V
...
.method public setFont(ILandroid/graphics/Typeface;)V
    .locals 2
...
.method public setSuperResources(Landroid/content/res/Resources;)V
    .locals 0

    iput-object p1, p0, Lcom/androlua/LuaResources;->l:Landroid/content/res/Resources;
...
.method public setTextArray(I[Ljava/lang/String;)V
    .locals 2
